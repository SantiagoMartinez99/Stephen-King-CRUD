...
import { mockUserData } from "../utils/loginData";
...
function Login() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // Validación básica con datos mock
    if (
      formData.username === mockUserData.username &&
      formData.password === mockUserData.password
    ) {
      // Disparar acción de inicio de sesión en Redux
      dispatch(login());
